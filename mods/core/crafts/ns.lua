craft = function(itemstack, player, old_craft_grid, craft_inv)
    if itemstack:get_name() == "core:ns_node" and old_craft_grid[1]:get_name() == "core:ns_node" and
        (old_craft_grid[2]:get_name() == "core:file_node" or old_craft_grid[2]:get_name() == "core:dir_node") then
